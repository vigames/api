...
<head>
    <meta charset="UTF-8">
    <title>Odzyskanie hasła dla Land of Shadows</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="message">
            ...
            <p>Aby potwierdzić zmianę hasła  na LoS kliknij w link poniżej:<br><br></p>
            <p><a href="https://los.vigames.eu/reset/{{ $aktywacja }}"> aktywuj konto </a></p>
